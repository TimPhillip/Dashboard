...
void MyUI::init(){
    ...
    lv_obj_t * btn = lv_btn_create(this->container);     /*Add a button the current screen*/
    ...
    this->console = lv_label_create(this->container);
    ...
    this->image = lv_img_create(this->container);
